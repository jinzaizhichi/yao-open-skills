...
| [Yao Cold Ledger Skill](skills/yao-cold-ledger-skill/SKILL.md)<br><sub>`yao-cold-ledger-skill`</sub> | 分析或创作冷账叙事中文关系故事，用精确数字、工序、物件回环、克制对白和留白承载情绪，并内置原创距离与事实边界检查。 | `冷账叙事`、`叙事`、`写作`、`文风分析` 等 | [说明](docs/skills/yao-cold-ledger-skill.md) · [Skill](skills/yao-cold-ledger-skill/SKILL.md) · [目录](skills/yao-cold-ledger-skill) · [GitHub](https://github.com/yaojingang/yao-open-skills/tree/main/skills/yao-cold-ledger-skill) |
...
| [Yao Positioning Skill](skills/yao-positioning-skill/SKILL.md)<br><sub>`yao-positioning-skill`</sub> | 基于《定位》、现代产品定位、课程营销与证据治理，完成竞品研究、需求洞察、D6 优势诊断、定位方案比较和离线可视化报告。 | `定位`、`战略`、`竞争`、`证据` 等 | [说明](docs/skills/yao-positioning-skill.md) · [Skill](skills/yao-positioning-skill/SKILL.md) · [目录](skills/yao-positioning-skill) · [GitHub](https://github.com/yaojingang/yao-open-skills/tree/main/skills/yao-positioning-skill) |
